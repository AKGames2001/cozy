    ...
    <>
      ...
      >
        <div className="flex items-center justify-center relative border-[1px] border-solid border-black w-full overflow-hidden image-hover">
          ...
          <img
            className="h-[125px] md:h-[250px] transition-transform ease-in-out duration-100"
            src={"/images/" + props.data.image}
            alt="/"
          />
          <div className="hidden md:block absolute bottom-4 right-4 bg-[#c4c4c4] rounded-full p-2">
            <FaRegHeart className="text-[#555555]" />
          </div>
          <div className="hidden md:flex absolute w-full h-14 item-hover bg-white text-white gap-[2px]">
